...
import tactic.generalizes tactic.type_based_naming
...
-- TODO copied from tactic/generalizes
/--
...
equation).
-/
meta def generalizes.step2 (md : transparency)
...
-/
meta def generalizes.step3 (e : expr) (js ks eqs eq_proofs : list expr)
  : tactic unit :=
focus1 $ do
